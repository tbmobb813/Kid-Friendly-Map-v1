...
const MapLibreRouteView = (props) => {
  return (
    <div data-testid={props.testID || 'mock-maplibre-route-view'}>
      {props.origin && <div data-testid="origin-marker" data-coords={JSON.stringify(props.origin)} />}
      {props.destination && <div data-testid="destination-marker" data-coords={JSON.stringify(props.destination)} />}
