            ...
            try {
                ...
                if (status !== "granted") {
                    ...
                    if (Platform.OS === 'android') {
                        Alert.alert("Location Permission", "This app needs location access to show you nearby places and directions. Please enable location in your device settings.", [
