...
export function useRegionalData() {
    ...
    const formatters = useMemo(() => ({
        currency: (amount) => formatCurrency(amount, currentRegion.currency),
        distance: (meters) => formatDistance(meters, userPreferences.preferredUnits),
        temperature: (celsius) => formatTemperature(celsius, userPreferences.preferredUnits),
        time: (date) => getLocalizedTime(date, currentRegion.timezone),
