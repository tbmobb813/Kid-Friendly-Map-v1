...
try {
  ...
  if (legacy) {
    ...
    global.simpleRender = legacy.simpleRender;
    global.getByTestId = legacy.getByTestId;
    global.queryByTestId = legacy.queryByTestId;
    global.fireEvent = legacy.fireEvent;
    global.act = legacy.act;
  }
} catch (e) {
