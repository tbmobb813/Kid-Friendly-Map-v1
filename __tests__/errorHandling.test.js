...
describe('Error Handling Utils', () => {
    ...
    describe('withRetry', () => {
        ...
        it('should fail after max attempts', async () => {
            ...
            await expect(withRetry(mockOperation, { maxAttempts: 2, delayMs: 10 })).rejects.toThrow('Persistent failure');
    ...
    describe('SafeAsyncStorage', () => {
        ...
        it('should handle batch operations', async () => {
            ...
            expect(mockAsyncStorage.setItem).toHaveBeenCalledWith('key2', JSON.stringify({ new: 'data' }));
        });
    });
