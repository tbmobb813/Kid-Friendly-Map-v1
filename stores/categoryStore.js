...
export const [CategoryProvider, useCategoryStoreInternal] = createContextHook(() => {
    ...
    const getPlaceCategory = (customCategoryId) => {
...
export const useCategoryManagement = () => {
    ...
    return {
        ...store,
        canCreateCategory: (createdBy) => {
            if (createdBy === 'parent')
                return true;
            if (!store.settings.allowChildToCreateCategories)
                return false;
