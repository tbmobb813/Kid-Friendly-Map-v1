...
export function validateSafeZone(safeZone) {
    const errors = [];
    const warnings = [];
    if (!safeZone) {
...
export function validatePhotoCheckIn(checkIn) {
    const errors = [];
    const warnings = [];
    if (!checkIn) {
...
export function validateAndSanitizeFormData(data, schema) {
    const errors = [];
    const warnings = [];
    const sanitizedData = {};
...
export function logValidationResult(context, result) {
    if (!result.isValid) {
...
export function validateDistance(distance, context = 'location') {
    const errors = [];
    const warnings = [];
