 ...
 */
export function verifyLocationProximity(currentLat, currentLon, targetLat, targetLon, radiusMeters = 100) {
 ...
 */
export function getLocationAccuracyDescription(distance) {
    if (distance <= 50) {
        return "Very close";
    }
