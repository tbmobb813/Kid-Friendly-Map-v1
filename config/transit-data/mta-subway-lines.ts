...
export const mtaSubwayLines: SubwayLine[] = [
  // IRT Lines (Numbered)
  {
    ...
    safetyNote: "This line can get very crowded during rush hours - wait for the next train if it's too full"
  },
  {
    id: "4",
    name: "4 Train",
  ...
  // IND/BMT Lines (Letters)
  {
    ...
    safetyNote: "This train takes a long time end-to-end - make sure you're going the right direction"
  },
  {
    id: "L",
    name: "L Train",
...
export const subwayEducationalContent = {
  express_vs_local: {
    ...
    explanation: "Express trains are like school buses that only stop at main stops to go faster. Local trains are like regular buses that stop at every single stop along the way.",
    kidTip: "If you're going far, express trains save time. If you're going somewhere close, local trains might be better."
  },
  transfers: {
    title: "How to Transfer Between Trains",
    explanation: "Sometimes you need to take two different trains to get where you're going, like switching from a bike to a scooter. Look for signs that show which trains you can connect to.",
    kidTip: "Follow the signs with arrows and train symbols. Don't be afraid to ask MTA workers for help!"
  },
  directions: {
    title: "Uptown vs Downtown",
    explanation: "Uptown means going north (toward the Bronx), and Downtown means going south (toward Brooklyn). It's like thinking of the city as a big hill - up toward the top, down toward the bottom.",
    kidTip: "Look at the signs on the platform - they'll say 'Uptown' or 'Downtown' with the neighborhoods you're heading toward."
  },
  payment: {
    title: "How to Pay for the Subway",
    explanation: "You can use a MetroCard (plastic card) or OMNY (tap your phone or card). It's like paying for a ride at an amusement park.",
    kidTip: "Let the adult handle the payment, but you can help by tapping the card or phone on the round reader."
  }
};