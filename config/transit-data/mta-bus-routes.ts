...
export const mtaBusRoutes: BusRoute[] = [
  ...
  },
  {
    ...
    kidFriendlyDescription: "The Queens bus that goes through lots of different cultural neighborhoods",
    popularStops: [
  ...
  },
  {
    ...
    kidFriendlyDescription: "The Staten Island bus that goes from the ferry to the southern neighborhoods",
    popularStops: [
      "St George Terminal",
      "Port Richmond",
      "West Brighton", 
