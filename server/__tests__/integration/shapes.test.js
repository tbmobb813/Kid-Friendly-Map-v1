...
describe('Shapes endpoint', () => {
  beforeAll(() => {
    ...
    fs.writeFileSync(tripsFile, JSON.stringify({ testTrip: { trip_id: 'testTrip', route_id: 'R1', shape_id: 'shape1', trip_headsign: 'Test Dest' } }));
    fs.writeFileSync(path.join(dataDir,'routes.json'), JSON.stringify({ R1: { route_id: 'R1', route_short_name: 'R1' } }));
    ...
    fs.writeFileSync(shapesFile, JSON.stringify({ shape1: [
      { shape_id: 'shape1', shape_pt_lat: '40.0', shape_pt_lon: '-73.0', shape_pt_sequence: '1' },
      { shape_id: 'shape1', shape_pt_lat: '40.1', shape_pt_lon: '-73.1', shape_pt_sequence: '2' },
      { shape_id: 'shape1', shape_pt_lat: '40.2', shape_pt_lon: '-73.2', shape_pt_sequence: '3' }
    ] }));
