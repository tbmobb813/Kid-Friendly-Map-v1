...
import { Train, Bus, MapPin, Clock, AlertTriangle, Info, Award, Lightbulb } from "lucide-react-native";
...
const MTAEducation: React.FC<MTAEducationProps> = ({ onClose }) => {
    ...
    <ScrollView style={styles.sectionContent} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.quickFactsContainer}>
        ...
        <View style={styles.factCard}>
          ...
          <View style={styles.factContent}>
            ...
            <Text style={styles.factText}>NYC has 472 subway stations - more than any other city!</Text>
          </View>
        </View>
        ...
        <View style={styles.factCard}>
          ...
          <View style={styles.factContent}>
            ...
            <Text style={styles.factText}>The longest subway ride takes 2 hours and 45 minutes!</Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.safetyHighlight}>
        ...
        <Text style={styles.safetyText}>
          Always stay with a trusted adult and follow the safety rules to have fun exploring the city!
        </Text>
      </View>
    </ScrollView>
  );
  ...
  const renderSubwaySection = () => (
    <ScrollView style={styles.sectionContent} showsVerticalScrollIndicator={false}>
      ...
      {renderExpandableCard(
        ...
        <View>
          <Text style={styles.explanationText}>{subwayEducationalContent.express_vs_local.explanation}</Text>
      ...
      {renderExpandableCard(
        "Uptown vs Downtown", 
        <View>
          <Text style={styles.explanationText}>{subwayEducationalContent.directions.explanation}</Text>
          <View style={styles.tipBox}>
            <Lightbulb size={16} color="#FFA726" />
      ...
      {renderExpandableCard(
        ...
        <View>
          <Text style={styles.explanationText}>{subwayEducationalContent.transfers.explanation}</Text>
          <View style={styles.tipBox}>
            <Lightbulb size={16} color="#FFA726" />
  ...
  const renderBusSection = () => (
    <ScrollView style={styles.sectionContent} showsVerticalScrollIndicator={false}>
      ...
      {renderExpandableCard(
        "Types of Buses",
        <View>
          {Object.entries(busEducationalContent.bus_types.explanations).map(([type, explanation]) => (
            <View key={type} style={styles.busTypeCard}>
              <Text style={styles.busTypeName}>{type.charAt(0).toUpperCase() + type.slice(1)}</Text>
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case "subway": return renderSubwaySection();
    ...
    <View style={styles.container}>
      ...
      <View style={styles.sectionButtons}>
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
          {renderSectionButton("overview", <Info size={20} color={activeSection === "overview" ? "#FFFFFF" : Colors.primary} />, "Overview")}
          {renderSectionButton("subway", <Train size={20} color={activeSection === "subway" ? "#FFFFFF" : Colors.primary} />, "Subway")}
          {renderSectionButton("bus", <Bus size={20} color={activeSection === "bus" ? "#FFFFFF" : Colors.primary} />, "Bus")}
          {renderSectionButton("safety", <AlertTriangle size={20} color={activeSection === "safety" ? "#FFFFFF" : Colors.primary} />, "Safety")}
          {renderSectionButton("tips", <Lightbulb size={20} color={activeSection === "tips" ? "#FFFFFF" : Colors.primary} />, "Tips")}
        </ScrollView>
      </View>
