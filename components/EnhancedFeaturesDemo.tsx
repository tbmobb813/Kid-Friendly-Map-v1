...
export default function EnhancedFeaturesDemo() {
  const [activeTab, setActiveTab] = useState<'map' | 'voice' | 'storage' | 'ai' | 'smart-nav'>('smart-nav');
  ...
  return (
    <View className="flex-1 bg-gray-50">
      ...
      <ScrollView horizontal showsHorizontalScrollIndicator={false} className="bg-white border-b border-gray-200">
        ...
        >
          <Text className={`text-center font-semibold whitespace-nowrap ${
        ...
        <ScrollView className="flex-1 p-6">
          ...
          <View className="bg-white p-4 rounded-xl shadow-sm mb-4">
            ...
            <Text className="text-gray-600">
              Main Storage Keys: {storageInfo.mainKeys}
            </Text>
            <Text className="text-gray-600">
              Cache Keys: {storageInfo.cacheKeys}
            </Text>
          </View>
        ...
        <ScrollView className="flex-1">
          <View className="p-6">
              ...
              <View className="space-y-2">
                <View className="flex-row items-center">
                  ...
                  <View className="flex-1">
                    ...
                    <Text className="text-xs text-blue-600">Maximum safe zones, well-lit areas</Text>
                  </View>
                </View>
                <View className="flex-row items-center">
            ...
            <View className="bg-green-50 p-4 rounded-xl mb-4">
              ...
              <Text className="text-sm text-green-700 mb-1">
                • Speed/efficiency (25% weight)
              </Text>
              <Text className="text-sm text-green-700 mb-1">
                • Ease of travel (20% weight)
              </Text>
              <Text className="text-sm text-green-700 mb-1">
            ...
            <View className="bg-yellow-50 p-4 rounded-xl">
              ...
              <Text className="text-sm text-yellow-700 mb-1">
                • Tracks route selections
              </Text>
              <Text className="text-sm text-yellow-700 mb-1">
                • Analyzes time/context patterns
              </Text>
              <Text className="text-sm text-yellow-700 mb-1">
