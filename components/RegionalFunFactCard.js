...
const RegionalFunFactCard = ({ onDismiss }) => {
    ...
    const randomFact = regionalContent.funFacts[Math.floor(Math.random() * regionalContent.funFacts.length)];
    return (_jsxs(View, { style: styles.container, children: [_jsxs(View, { style: styles.header, children: [_jsx(View, { style: styles.iconContainer, children: _jsx(Lightbulb, { size: 20, color: Colors.secondary }) }), _jsxs(Text, { style: styles.title, children: ["Fun Fact about ", currentRegion.name] }), onDismiss && (_jsx(Pressable, { style: styles.dismissButton, onPress: onDismiss, children: _jsx(X, { size: 16, color: Colors.textLight }) }))] }), _jsx(Text, { style: styles.factText, children: randomFact })] }));
};
